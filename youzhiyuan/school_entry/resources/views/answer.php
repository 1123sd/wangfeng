...
$.getJSON(url+"?r=help/answer&token="+token+"&jsoncallback=?", function(data) {
    console.log(data);
    var html = '<ul class="answer-content">';
    
    for(var i = 0; i < data['data'].length; i++)
    {
    	html += '<a href="uploaDate.html">';
    	html += '<li class="answer-list">';
        html += '<h3 class="list-tit" style="color:red">'+data['data'][i]['question']+'</h3>';
        html += '<p class="list-txt" style="color:red">'+data['data'][i]['answer']+'</p>';
        html += '</a></li>';
    }
